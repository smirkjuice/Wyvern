...
elevate_BIOS:
    ...
    ; Enables 32-bit mode by setting bit 0 of the original control register.
    ; We can't set it directly though, so we'll need to copy it's contents 
    ; into EAX and back again.
    mov eax, cr0
    or eax, 0x00000001
    mov cr0, eax
